...
export const getProjectsInWorkspaceService = async (
  ...
  // Step 1 find all projects in the workspacec
...
export const getProjectByIdAndWorkspaceIdService = async (
  ...
  if (!project) {
    throw new NotFoundException(
      "Project not found or does not boing to the specificed workspace"
    );
  }
...
export const deleteProjectService = async (
  ...
  if (!project) {
    throw new NotFoundException(
      "Project not found or does not belong to the specified worksapce"
    );
  }
